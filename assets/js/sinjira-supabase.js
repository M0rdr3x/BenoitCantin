...
if(typeof location!=='undefined'&&/^\/admin\/sinjira(?:\/|$)/i.test(location.pathname)){queueMicrotask(()=>import('./v24-admin-health.js?v=24.4.12').catch(err=>console.warn('[SINJIRA admin health loader]',err)))}
