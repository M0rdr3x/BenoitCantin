...
// V24.4.40 — Assistant SINJIRA local, contextuel et sans fournisseur d’IA externe.
(function(){
  ...
  if(!document.querySelector('link[data-sinjira-assistant-style]')){
    ...
    style.href='/assets/css/sinjira-assistant.css?v=24.4.40';
  ...
  if(!document.querySelector('script[data-sinjira-assistant-script]')){
    ...
    script.src='/assets/js/sinjira-assistant.js?v=24.4.40';
    script.defer=true;
