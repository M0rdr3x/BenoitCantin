...
// V24.4.45 — Assistant SINJIRA local, contextuel et sans fournisseur d’IA externe.
(function(){
  ...
  if(!document.querySelector('link[data-sinjira-assistant-style]')){
    ...
    style.href='/assets/css/sinjira-assistant.css?v=24.4.45';
  ...
  if(!document.querySelector('script[data-sinjira-assistant-script]')){
    ...
    script.src='/assets/js/sinjira-assistant.js?v=24.4.45';
    script.defer=true;
