...
SELF_TEST = 'python3 scripts/validate_mobile_character_hub_workflow_security.py --self-test'
SELF_CHECK = 'python3 scripts/validate_mobile_character_hub_workflow_security.py'
HISTORICAL = (
...
TRIGGER_PATHS = (
    ...
    "      - 'mobile-native/NATIVE_CHARACTER_HUB_V25.md'",
    "      - 'compte/mon-personnage.html'",
    "      - 'assets/js/sinjira-mon-personnage.js'",
    ...
    "      - 'scripts/validate_mobile_native_life_story_hub_v25.py'",
    ...
    "      - 'scripts/validate_mobile_character_hub_workflow_security.py'",
...
def mutation_cases(text: str) -> tuple[tuple[str, str], ...]:
    ...
    return (
        ...
        ('chemin garde retiré', text.replace("      - 'scripts/validate_mobile_character_hub_workflow_security.py'\n", '', 1)),
        ('chemin RPC propriétaire retiré', text.replace("      - 'scripts/validate_owner_character_rpc_v24_5_20.py'\n", '', 1)),
        ('chemin ledger retiré', text.replace("      - 'scripts/validate_production_migration_ledger.py'\n", '', 1)),
...
def main() -> int:
    ...
    validate_repo_state()
    print(
        'OK CI Mon personnage natif: runner/Python/Node/actions immuables, Git read-only, '
