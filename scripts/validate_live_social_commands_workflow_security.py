...
def validate_text(text: str) -> None:
    ...
    if test_indexes != sorted(test_indexes):
        fail('ordre commandes -> fondation -> modération -> invitations -> advisor non respecté')
...
def main() -> int:
    ...
    try:
        if '--self-test' in sys.argv[1:]:
            ...
            validate_text(text)
            print('OK: contrat CI commandes En direct V25 respecté, preuves locales séparées de la gouvernance production')
