...
FORBIDDEN = {
    ...
    'lecture IP brute true-client': 'true-client-ip',
...
def main() -> int:
    ...
    if args.self_test:
        self_test()
        print('OK auto-test security-context request boundary.')
        return 0
    ...
    if errors:
        ...
        for error in errors:
            print('- ' + error)
        return 1
    print('OK security-context: JWT/session avant corps, JSON exact borné à 4 KiB pendant le flux, logs fixes, aucune IP brute/GPS.')
    return 0
