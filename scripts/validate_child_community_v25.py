...
req('createorreplacefunctionpublic.sinjira_my_age_band()returnstextlanguagesqlstablesecuritydefinersetsearch_path=pg_catalog,public,authas$self_age
for marker in (
...
print('OK V25: Communauté Junior 11–12 isolée, parent-opt-in, pseudonymisée, sans DM/coordonnées/commerce et testée localement.')
 in m,
    'Le wrapper sinjira_my_age_band SECURITY DEFINER n a pas un search_path borné.')
req('createorreplacefunctionprivate.sinjira_is_junior(p_user_iduuid)returnsbooleanlanguagesqlstablesecuritydefinersetsearch_path=pg_catalog,publicas$junior
for marker in (
    'createschemaifnotexistssinjira_v25_internal',
    "'sinjira_my_age_band'",
    'securityinvoker',
...
print('OK V25: Communauté Junior 11–12 isolée, parent-opt-in, pseudonymisée, sans DM/coordonnées/commerce et testée localement.')
 in m,
    'Le helper privé sinjira_is_junior SECURITY DEFINER n a pas un search_path borné.')
req('createorreplacefunctionprivate.has_accepted_junior_community_rules(p_user_iduuid)returnsbooleanlanguagesqlstablesecuritydefinersetsearch_path=pg_catalog,publicas$junior
for marker in (
    'createschemaifnotexistssinjira_v25_internal',
    "'sinjira_my_age_band'",
    'securityinvoker',
...
print('OK V25: Communauté Junior 11–12 isolée, parent-opt-in, pseudonymisée, sans DM/coordonnées/commerce et testée localement.')
 in m,
    'Le helper privé des règles Junior SECURITY DEFINER n a pas un search_path borné.')
for marker in (
    'createschemaifnotexistssinjira_v25_internal',
    "'sinjira_my_age_band'",
    'securityinvoker',
