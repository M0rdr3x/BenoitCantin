...
SELF_TEST = 'python3 scripts/validate_mobile_messages_hub_workflow_security.py --self-test'
SELF_CHECK = 'python3 scripts/validate_mobile_messages_hub_workflow_security.py'
HISTORICAL = (
...
TRIGGER_PATHS = (
    ...
    "      - 'mobile-native/NATIVE_MESSAGES_HUB_V25.md'",
    ...
    "      - 'scripts/validate_mobile_messages_hub_workflow_security.py'",
...
def mutation_cases(text: str) -> tuple[tuple[str, str], ...]:
    ...
    return (
        ...
        ('chemin Messages retiré', text.replace("      - 'mobile-native/NativeMessagesHub.tsx'\n", '', 1)),
        ('chemin garde retiré', text.replace("      - 'scripts/validate_mobile_messages_hub_workflow_security.py'\n", '', 1)),
...
def main() -> int:
    ...
    validate_repo_state()
    print(
        'OK CI Messages natifs: runner/Python/Node/actions immuables, Git read-only, '
