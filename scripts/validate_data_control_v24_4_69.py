...
def main():
    ...
    require(hold_migration,[
        ...
        'privacy_requests_user_id_fkey','on delete set null','safety_escalation_cases_source_report_id_fkey',
        'public.privacy_export_my_extended_data','grant execute on function public.privacy_export_my_extended_data() to authenticated,service_role',
        "'privacy_requests'","'points_account'","'points_ledger'","'dating_profile'","'dating_preferences'",
        "'dating_connections'","'dating_messages'","'dating_meet_requests'","'reports_submitted'",
        "to_jsonb(r)-'reporter_user_id'-'snapshot'"
    ],'contrat conservation légale et export étendu')
    ...
    print('OK données V24.4.83: export paginé + modules privés récents, suppression admin bloquée, AAL2, Storage et conservations légales protégés.')
    return 0
