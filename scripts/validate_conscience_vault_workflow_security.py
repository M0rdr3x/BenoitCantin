#!/usr/bin/env python3
"""Security contract for the V25 Conscience Vault functional workflow."""
...
WORKFLOW = Path('.github/workflows/sinjira-conscience-vault-functional-v25.yml')
CHECKOUT_SHA = 'd23441a48e516b6c34aea4fa41551a30e30af803'
SETUP_PYTHON_SHA = 'ece7cb06caefa5fff74198d8649806c4678c61a1'
SUPABASE_SETUP_SHA = '3c2f5e2ae34c34e428e8e206e2c4d21fa2d20fbf'
PYTHON_VERSION = '3.12.14'
SUPABASE_VERSION = '2.111.0'
CONTRACT_TRIGGER = "      - 'scripts/validate_conscience_vault_workflow_security.py'"
VAULT_TRIGGER = "      - 'supabase/functions/conscience-vault/**'"
SELF_TEST_STEP = (
    '      - name: Auto-tester le contrat CI Coffre AAL2\n'
    '        run: python scripts/validate_conscience_vault_workflow_security.py --self-test\n'
)
CONTRACT_STEP = (
    '      - name: Vérifier le contrat CI Coffre AAL2\n'
    '        run: python scripts/validate_conscience_vault_workflow_security.py\n'
)
...
def validate_text(text: str) -> None:
    required = [
        ...
        'python3 scripts/validate_conscience_vault_functional_smoke.py',
        ...
        'python3 scripts/smoke_conscience_vault_functional_local.py',
    ...
    if text.count(VAULT_TRIGGER) != 2:
        fail('les changements de la fonction Coffre doivent déclencher PR et push')
    ...
    pg_index = text.index('supabase test db supabase/tests/personal_consciousness_vault_v25.test.sql --local')
    smoke_index = text.index('python3 scripts/smoke_conscience_vault_functional_local.py')
    if pg_index >= smoke_index:
        fail('pgTAP doit rester avant le smoke HTTP Coffre')
...
def main() -> None:
    ...
    if args.self_test:
        ...
        validate_text(text)
        print('OK: contrat CI Coffre fonctionnel AAL2 V25 respecté')
