...
def main() -> int:
    for path in (M1, M2, EDGE, AUTH, CONFIG, TEST, MANIFEST):
    ...
    require('select plan(35);' in test, 'contrat pgTAP Mon IA doit rester à 35 assertions')

    print('OK readiness Mon IA V25: 2 migrations privées, 35 pgTAP, AAL2/ai_private, JWT obligatoire, runtime non configuré et aucune source Registre.')
    return 0
