#!/usr/bin/env python3
"""Security contract for the private life-story delivery CI workflow."""
...
WORKFLOW = Path('.github/workflows/sinjira-life-story-delivery-v24-5-50.yml')
...
def self_test(text: str) -> None:
    mutations = {
        ...
        'remise retirée': text.replace('          python scripts/validate_life_story_delivery_v24_5_50.py\n', '', 1),
        'inventaire Edge retiré': text.replace('          python scripts/validate_edge_function_inventory.py\n', '', 1),
        'legacy privé retiré': text.replace('          python scripts/validate_life_story_legacy_v24_5_2.py\n', '', 1),
...
def main() -> None:
    ...
    if args.self_test:
        ...
        validate_text(text)
        print('OK: contrat CI remise Histoire de vie privée respecté')
