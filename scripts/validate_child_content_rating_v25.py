...
req("status<>'draft'andvisibility='public'andproduct_slugisnull" in pa,'La RLS générale réexpose un projet public payant ou un brouillon.')
req("(selectauth.uid())isnotnullandpublic.sinjira_my_age_band()='child'andstatus<>'draft'andvisibility='account'andchild_access_status='approved_11_12'andproduct_slugisnull" in pa,'La branche child account n exclut pas explicitement les brouillons et projets payants.')
