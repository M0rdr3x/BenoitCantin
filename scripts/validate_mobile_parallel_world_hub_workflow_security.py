...
SELF_TEST = 'python3 scripts/validate_mobile_parallel_world_hub_workflow_security.py --self-test'
SELF_CHECK = 'python3 scripts/validate_mobile_parallel_world_hub_workflow_security.py'
HISTORICAL = (
...
TRIGGER_PATHS = (
    ...
    "      - 'mobile-native/NATIVE_PARALLEL_WORLD_HUB_V25.md'",
    ...
    "      - 'scripts/validate_mobile_parallel_world_hub_workflow_security.py'",
...
def mutation_cases(text: str) -> tuple[tuple[str, str], ...]:
    ...
    return (
        ...
        ('chemin Monde parallèle retiré', text.replace("      - 'mobile-native/NativeParallelWorldHub.tsx'\n", '', 1)),
        ('chemin garde retiré', text.replace("      - 'scripts/validate_mobile_parallel_world_hub_workflow_security.py'\n", '', 1)),
...
def main() -> int:
    ...
    validate_repo_state()
    print(
        'OK CI Monde parallèle natif: runner/Python/Node/actions immuables, Git read-only, '
