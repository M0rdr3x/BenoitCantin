...
SELF_TEST = 'python3 scripts/validate_mobile_relations_hub_workflow_security.py --self-test'
SELF_CHECK = 'python3 scripts/validate_mobile_relations_hub_workflow_security.py'
HISTORICAL = (
...
TRIGGER_PATHS = (
    "      - 'mobile-native/NativeRelationsHub.tsx'",
    "      - 'mobile-native/NativeHomeHub.tsx'",
    "      - 'mobile-native/NativeModuleRouter.tsx'",
    "      - 'mobile-native/NATIVE_RELATIONS_HUB_V25.md'",
    "      - 'scripts/validate_mobile_native_relations_hub_v25.py'",
    "      - 'scripts/validate_global_safety_compliance_v24_4_83.py'",
    "      - 'scripts/validate_data_control_v24_4_69.py'",
    ...
    "      - 'scripts/validate_mobile_relations_hub_workflow_security.py'",
...
def mutation_cases(text: str) -> tuple[tuple[str, str], ...]:
    ...
    return (
        ...
        ('chemin Relations retiré', text.replace("      - 'mobile-native/NativeRelationsHub.tsx'\n", '', 1)),
        ('chemin conformité globale retiré', text.replace("      - 'scripts/validate_global_safety_compliance_v24_4_83.py'\n", '', 1)),
        ('chemin contrôle données retiré', text.replace("      - 'scripts/validate_data_control_v24_4_69.py'\n", '', 1)),
        ('chemin Vie privée retiré', text.replace("      - 'scripts/validate_mobile_native_privacy_hub_v25.py'\n", '', 1)),
        ('chemin garde retiré', text.replace("      - 'scripts/validate_mobile_relations_hub_workflow_security.py'\n", '', 1)),
...
def main() -> int:
    ...
    validate_repo_state()
    print(
        'OK CI Relations natif: runner/Python/Node/actions immuables, Git read-only, '
