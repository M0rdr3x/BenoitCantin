...
**Aucun fournisseur externe de courriel n’est activé en V24.5.2.** V24.5.2 n’active aucun fournisseur externe de courriel. Les liens peuvent être remis manuellement. Un éventuel transport automatisé futur devra faire l’objet d’une décision distincte concernant la confidentialité, la sécurité, le coût et le fournisseur.
