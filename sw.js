const CACHE='benoitcantin-v24-4-11-public-1';
const CORE=[
...
self.addEventListener('fetch',e=>{
  ...
  if(liveAsset){e.respondWith(fetch(r).then(resp=>{if(resp.ok)caches.open(CACHE).then(c=>c.put(r,resp.clone()));return resp}).catch(()=>caches.match(r)));return}
