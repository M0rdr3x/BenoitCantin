const CACHE='benoitcantin-v24-3-3-public-1';
const CORE=[
  '/','/offline.html','/assets/css/site.css','/assets/css/v19-pro.css','/assets/css/v24-platform.css','/assets/css/v24-3-2-fixes.css','/assets/css/v24-3-3-fixes.css',
  '/assets/js/site.js','/assets/js/v24-3-1-runtime.js','/assets/js/v24-3-2-runtime.js','/assets/js/v24-3-3-runtime.js',
...
self.addEventListener('fetch',e=>{
  ...
  if(liveAsset){
    e.respondWith(fetch(r).then(resp=>{if(resp.ok)caches.open(CACHE).then(c=>c.put(r,resp.clone()));return resp}).catch(()=>caches.match(r)));
    return;
  }
