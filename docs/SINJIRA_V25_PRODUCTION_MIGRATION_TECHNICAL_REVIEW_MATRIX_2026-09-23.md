...
| 11 | `20260919013000_sinjira_v25_child_pending_guardian_redeem.sql` | 121 lignes; 1 definer; 1 update | Vérifier transition `child_pending`, unicité/expiration, compatibilité stricte codes 10/16 caractères et absence d'élévation avant validation. |
...
| 13 | `20260919023000_sinjira_v25_guardian_invite_aal2.sql` | 135 lignes; 1 definer; contrainte + insert + delete; AAL2 | Vérifier AAL2 obligatoire, rotation/invalidation, nouveau code 16 hex à 64 bits réels et compatibilité temporaire des codes 10 caractères. |
