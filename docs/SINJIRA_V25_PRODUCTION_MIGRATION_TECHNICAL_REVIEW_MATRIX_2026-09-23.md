...
| 27 | `20260919093000_sinjira_v25_private_novel_catalog.sql` | 191 lignes; table privée + RLS; 2 definer; insert + update; `service_role` | Vérifier séparation métadonnées/catalogue/asset privé et délivrance seulement avec droit canonique. |
| 28 | `20260919100000_sinjira_v25_private_profile_age_11.sql` | 311 lignes; 2 definer; 2 inserts + 2 updates; âge | Vérifier coffre profil privé, âge minimum, champs permis et isolation totale entre comptes. |
| 29 | `20260919103000_sinjira_v25_livre_i_catalog_seed.sql` | 61 lignes; 2 inserts + 2 updates | Vérifier idempotence du seed, slugs stables et absence d'écrasement d'une donnée production plus récente. |
