...
| 13 | `20260919023000_sinjira_v25_guardian_invite_aal2.sql` | 134 lignes; 1 definer; contrainte + insert + delete; AAL2 | Vérifier AAL2 obligatoire, rotation/invalidation, nouveau code 16 hex à 64 bits réels et compatibilité temporaire des codes 10 caractères. |
