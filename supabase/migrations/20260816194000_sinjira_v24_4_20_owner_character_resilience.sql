...
begin
  ...
  -- Répare la fiche utilisée par le Réseau personnage et la messagerie RP.
  ...
  -- Garantit une Chronique technique minimale sans écraser l'histoire existante.
  ...
  -- Le propriétaire a toujours accès au Monde parallèle principal. Le numéro
  -- de Pionnier existant, s'il y en a un, est conservé.
