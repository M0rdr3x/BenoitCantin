-- SINJIRA™ V25 — isolation d'identité entre réseau Compte et réseau Personnage.
-- Un tuteur autorisé peut voir qu'un contact existe, mais le réseau Personnage ne doit
-- jamais être recollé au pseudo du compte réel situé derrière le personnage.
...
comment on function public.get_guardian_youth_contacts(uuid) is
  'V25 identité cloisonnée: réseau Compte => pseudo public; réseau Personnage => nom public du personnage. Aucun recoupement vers le pseudo du compte réel, UUID, display_name, heure précise ou contenu.';
